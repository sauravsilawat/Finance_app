                ...
                <TouchableOpacity
                    ...
                    <View className="flex-1">
                        <View className="flex-row">
                            <Text className="font-playbold text-[10px]">{item.title}</Text>
                            <Text className="font-playRegular text-[10px]">{item.loc}</Text>
                        </View>
                        <View className={`flex-row gap-x-5 mt-5 ${selected === item.key ? "mt-2" : ""}`}>
                            <View className="mb-1 gap-y-1">
                                <Text className="text-[8px] text-gray-400">Total Value</Text>
                                <Text className="text-[8px]">{item.tv}</Text>
                            </View>
                            <View className="mb-1 gap-y-1">
                                <Text className="text-[8px] text-gray-400">Starting at</Text>
                                <Text className="text-[8px]">{item.start}</Text>
                            </View>
                            <View className="mb-1 gap-y-1">
                                <Text className="text-[8px] text-gray-400">People Registered</Text>
                                <Text className="text-[8px]">{item.pr}</Text>
                            </View>
                        </View>
                        {selected === item.key && (
                            <>
                                <View className="flex-row gap-x-2 pt-1">
                                    <Text className='text-[8px] text-gray-600'>4 Bedrooms</Text>
                                    <Text className='text-[8px] text-gray-600'>.</Text>
                                    <Text className='text-[8px] text-gray-600'>4 Bath</Text>
                                    <Text className='text-[8px] text-gray-600'>.</Text>
                                    <Text className='text-[8px] text-gray-600'>2,900 Sqft</Text>
                                    <Text className='text-[8px] text-gray-600'>.</Text>
                                    <Text className='text-[8px] text-gray-600'>0.13 Acre(s)</Text>
                                </View>
                                <CustomButton
                                    title="LEARN MORE"
